...
| Domain SOP files | 85 | `domain/*.md` except `domain/README.md`, plus `domain/references/*.md` |
...
| construction drawing, 施工圖生產, Blueprint, Drawing Package, Cartoon Set | `domain/construction-drawing-production.md` |

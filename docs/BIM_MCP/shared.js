(function () {
  ...
  var PAGE_META = {
    ...
    "reference/tools-index": { title: "Tools 索引", desc: "192 個執行層工具，依用途分八類。" },
    "reference/domain-index": { title: "Domain 索引（85）", desc: "知識層：法規 / SOP / lessons。" },
    ...
    "domain-index": { title: "Domain 索引", desc: "85 個 SOP 知識。" },

...
Talk to Revit in plain language. Ask your AI client to *"dimension every wall on this view"* or *"check the curtain-wall elevations"*, and Revit does it — through **192 MCP tools** backed by **85 professional BIM SOPs** (building code, quantity take-off, compliance checks).
...
| Domain SOP files | 85 | `domain/*.md` except `README.md`, plus `domain/references/*.md` |
